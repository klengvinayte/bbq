...
RSpec.describe User, type: :model do
  describe ".find_for_facebook_oauth" do
    # Creating an object :access_token
    # We write into it the data that we got from their hash
    let(:access_token) do
      double(
        :access_token,
        provider: "facebook",
    ...
    # Situation: user found by provider and URL
